...
GOL-ANE (flex) & ANE (conv) & 83 t/s & 85 t/s \\
GOL-ANE (fixed) & ANE (conv) & 115 t/s & 80 t/s \\
GOL-ANE (stateful) & ANE (conv) & 170 t/s & 171 t/s \\
\bottomrule
\end{tabular}
...
The GOL-ANE stateful configuration reaches 171~tok/s decode, within
